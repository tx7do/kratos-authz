...
require (
	...
	github.com/tx7do/kratos-authz/engine/casbin v0.0.0-20230202083913-af419ce8f18d
	github.com/tx7do/kratos-authz/engine/opa v0.0.0-20221220154012-95ab9f84cac0
)
...
require (
	...
	github.com/casbin/casbin/v2 v2.60.1 // indirect
