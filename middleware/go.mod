...
require (
	...
	github.com/tx7do/kratos-authz/engine/casbin v0.0.0-20221201050117-6aa522b7e530
	github.com/tx7do/kratos-authz/engine/opa v0.0.0-20221201050117-6aa522b7e530
)
